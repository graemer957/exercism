...
1. Take a look at `README.md` to understand the problem, and _attempt_ to build a mental model. I use the word attempt because sometimes it's just that – an attempt!
...
6. Review the solution – apply small refactors now that I understand the problem better, and add comments.
7. Whilst I may have further ideas on how to improve or perform larger refactors, I now submit the solution.
8. Take a look at community solutions and incorporate what I learn into planning next steps.
